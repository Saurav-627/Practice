...
const Testimonials = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content:
        "A fantastic experience! Will definitely use this service again.",
      avatar_url: "Hero.jpeg",
    },
    {
      id: 3,
      ...
      content: "Simply wonderful! This has changed my life for the better.",
      avatar_url: "Hero.jpeg",
    },
    {
      id: 4,
      ...
      content: "Great service and support. Highly satisfied!",
      avatar_url: "Hero.jpeg",
    },
    {
      id: 5,
      ...
      <Container>
        <div className="px-2 pocket-testimonial__inner">
          ...
          {/* <div className="navigation-button">
            <button className="test-prev"></button>
